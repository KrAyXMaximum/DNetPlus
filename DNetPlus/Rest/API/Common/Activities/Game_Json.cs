...
namespace Discord.API
{
    internal class GameJson
    {
        ...
        [JsonProperty("assets")]
        public Optional<API.GameAssetsJson> Assets { get; set; }
        [JsonProperty("party")]
        public Optional<API.GamePartyJson> Party { get; set; }
        [JsonProperty("secrets")]
        public Optional<API.GameSecretsJson> Secrets { get; set; }
        [JsonProperty("timestamps")]
        public Optional<API.GameTimestampsJson> Timestamps { get; set; }
